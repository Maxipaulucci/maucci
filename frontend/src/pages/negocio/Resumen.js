  ...
  return (
    <div className="negocio-page">
      <div className="negocio-page-container">
                  ...
                  <div className="resumen-grafico-container">
                    <div className="resumen-grafico-lineas">
                      <div className="resumen-grafico-eje-y">
                        ...
                        <div className="resumen-eje-y-escala">
                          {(() => {
                            ...
                            const alto = 300;
                            const escala = generarEscalaY();
                            return escala.map((valor, index) => {
                              // Calcular posición Y: 0 está abajo (300px), max está arriba (0px)
                              const posicionY = alto - (valor / alturaMaxima) * alto;
                              return (
                                <span 
                                  key={index} 
                                  style={{ top: `${posicionY}px` }}
                                >
                      ...
                      <div className="resumen-grafico-area">
                        <svg className="resumen-grafico-svg" viewBox="0 0 1000 300" preserveAspectRatio="none">
                          <defs>
                          ...
                          <path
                            ...
                            d={(() => {
                              ...
                              datos.forEach((dato, index) => {
                                const x = index * pasoX;
                                const y = alto - (dato.ganancia / alturaMaxima) * alto;
                                path += ` L ${x} ${y}`;
                              });
                              path += ` L ${ancho} ${alto} Z`;
                              return path;
                          ...
                          {obtenerDatosGrafico().map((dato, index) => {
                            ...
                            return (
                              <g 
                                key={index} 
                                className="resumen-grafico-punto-grupo"
        ...
        {puntoSeleccionado && (
          <div className="resumen-modal-overlay" onClick={() => setPuntoSeleccionado(null)}>
            <div className="resumen-modal-content" onClick={(e) => e.stopPropagation()}>
              <div className="resumen-modal-header">
                <h3>Detalle del día</h3>
                <button 
                  className="resumen-modal-close"
                  onClick={() => setPuntoSeleccionado(null)}
                >
                  ×
                </button>
              </div>
              <div className="resumen-modal-body">
                <div className="resumen-modal-item">
                  <span className="resumen-modal-label">Día:</span>
                  <span className="resumen-modal-value">
                    {formatearFechaMostrar(puntoSeleccionado.fecha)}
                  </span>
                </div>
                <div className="resumen-modal-item">
                  <span className="resumen-modal-label">Ganancia:</span>
                  <span className="resumen-modal-value resumen-modal-ganancia">
                    ${puntoSeleccionado.ganancia.toLocaleString('es-AR')}
                  </span>
                </div>
              </div>
            </div>
